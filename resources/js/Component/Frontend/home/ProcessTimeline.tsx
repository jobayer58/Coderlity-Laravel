  ...
  return (
    <section className="timeline-section">
      ...
      <p className="timeline-subtitle">
        Experience our systematic approach to digital excellence. We
        meticulously guide you through every phase, ensuring <br /> a seamless
        and successful transformation of your vision into reality.
      </p>
      ...
      <div className="process-container">
        {buttons.map((btn, index) => (
          <div key={btn.id} className={`process-item ${btn.position}`}>
            ...
            {index === 0 && <div className="dotted-line left"></div>}
